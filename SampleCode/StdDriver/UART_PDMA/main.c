...
void PDMA_UART(int32_t i32option)
{
    ...
    if(i32option == '1')
    {
        ...
        printf("  Please connect UART0_RXD(PB.12) <--> UART0_TXD(PB.13) before testing.\n");
        printf("  After connecting PB.12 <--> PB.13, press any key to start transfer.\n");
