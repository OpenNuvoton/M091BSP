...
void AutoBaudRate_TxTest(void)
{
    ...
    do
    {
        ...
        {
        case '1':
            UART0->BAUD = UART_BAUD_MODE2 | UART_BAUD_MODE2_DIVIDER(__HIRC, 38400);
            break;
        case '2':
            UART0->BAUD = UART_BAUD_MODE2 | UART_BAUD_MODE2_DIVIDER(__HIRC, 57600);
            break;
        default:
...
uint32_t GetUartBaudrate(UART_T *uart)
{
    ...
    uint32_t u32ClkTbl[] = {0ul, 0ul, 0ul, __HIRC, 0ul, __LIRC};
