 ...
 * $Revision: 2 $
 * $Date: 20/06/10 2:23p $
 * @brief    Use MANCH to do TX and RX loopback test by DMA
 * @note
...
int32_t main(void)
{
    ...
    printf("+------------------------------------------------------------------------+\n");
    printf("  This sample code will use TX pin (PB.7) to send MANCH encoded data and \n");
    printf("  receive by RX pin (PB.6). To use this sample code, please connect TX and RX.\n\n");
