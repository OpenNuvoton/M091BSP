...
typedef struct
{
    /**
     * @var TIMER_T::CTL
     * Offset: 0x00/0x20  Timer0~5 Control Register
     * ---------------------------------------------------------------------------------------------------
     ...
     * |[11]    |MTRGTMEN  |Manchester Edge Trigger Timer Enable Bit
     * |        |          |0 = Manchester Edge Trigger Timer Disabled.
     * |        |          |1 = Manchester Edge Trigger Timer Enabled. 
     ...
     * |        |          |User can set INTERCAPSEL (TIMERx_EXTCTL[10:8]) to decide which LIRC as timer capture source.
     ...
     * |        |          |0 = Timer time-out interrupt signal is used to trigger BPWM, ADC, DAC and PDMA.
     * |        |          |1 = Capture interrupt signal is used to trigger BPWM, ADC, DAC and PDMA.
     ...
     * |        |          |Note 3: Setting this bit enable/disable needs 2 * TMR_CLK period to become active.
     ...
     * @var TIMER_T::CMP
     * Offset: 0x04/0x24  Timer0~5 Comparator Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var TIMER_T::INTSTS
     * Offset: 0x08/0x28  Timer0~5 Interrupt Status Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |Note: This bit is cleared by writing 1 to it.
     * @var TIMER_T::CNT
     * Offset: 0x0C/0x2C  Timer0~5 Data Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var TIMER_T::CAP
     * Offset: 0x10/0x30  Timer0~5 Capture Data Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var TIMER_T::EXTCTL
     * Offset: 0x14/0x34  Timer0~5 External Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |00 = A Falling edge on TMx_EXT (x= 0~5) pin or LIRC will be detected.
     * |        |          |01 = A Rising edge on TMx_EXT (x= 0~5) pin or LIRC will be detected.
     * |        |          |10 = Either Rising or Falling edge on TMx_EXT (x= 0~5) pin or LIRC will be detected.
     * |        |          |11 = Reserved.
     ...
     * |        |          |Note 1: When CAPFUNCS is 0, transition on TMx_EXT (x= 0~5) pin is using to save current 24-bit timer counter value (CNT value) to CAPDAT field.
     * |        |          |Note 2: When CAPFUNCS is 1, transition on TMx_EXT (x= 0~5) pin is using to save current 24-bit timer counter value (CNT value) to CAPDAT field then CNT value will be reset immediately.
     * |[5]     |CAPIEN    |Timer External Capture Interrupt Enable Bit
     * |        |          |0 = TMx_EXT (x= 0~5) pin or LIRC detection Interrupt Disabled.
     * |        |          |1 = TMx_EXT (x= 0~5) pin or LIRC detection Interrupt Enabled.
     ...
     * |        |          |For example, while CAPIEN = 1, CAPEN = 1, and CAPEDGE = 00, a 1 to 0 transition on the TMx_EXT (x= 0~5) pin will cause the CAPIF to be set then the interrupt signal is generated and sent to NVIC to inform CPU.
     * |[6]     |CAPDBEN   |Timer External Capture Pin De-bounce Enable Bit
     * |        |          |0 = TMx_EXT (x= 0~5) pin de-bounce Disabled.
     * |        |          |1 = TMx_EXT (x= 0~5) pin de-bounce Enabled.
     ...
     * |        |          |1 = Reserved.
     * @var TIMER_T::EINTSTS
     * Offset: 0x18/0x38  Timer0~5 External Interrupt Status Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |CAPIF     |Timer External Capture Interrupt Flag
     * |        |          |This bit indicates the timer external capture interrupt flag status.
     * |        |          |0 = TMx_EXT (x= 0~5) pin interrupt did not occur.
     * |        |          |1 = TMx_EXT (x= 0~5) pin interrupt occurred.
     * |        |          |Note 1: This bit is cleared by writing 1 to it.
     * |        |          |Note 2: When CAPEN (TIMERx_EXTCTL[3]) bit is set, CAPFUNCS (TIMERx_EXTCTL[4]) bit is 0, and a transition on TMx_EXT (x= 0~5) pin matched the CAPEDGE (TIMERx_EXTCTL[2:1]) setting, this bit will set to 1 by hardware.
...
#define TIMER_CTL_MTRGTMEN_Pos           (11)                                              /*!< TIMER_T::CTL: MTRGTMEN Position        */
#define TIMER_CTL_MTRGTMEN_Msk           (0x1ul << TIMER_CTL_MTRGTMEN_Pos)                 /*!< TIMER_T::CTL: MTRGTMEN Mask            */
