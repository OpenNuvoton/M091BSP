 ...
 * $Revision: 8 $
 * $Date: 20/06/11 3:42p $
 * @brief    M091 Series Peripheral Access Layer Header File
 *
 * @note
...
/**
  \mainpage NuMicro M091 Driver Reference Guide
  *
  * <b>Introduction</b>
  *
  * This user manual describes the usage of M091 Series MCU device driver
  *
  * <b>Disclaimer</b>
  *
...
#include "system_M091.h"          		/*!< M091 System                                          */
