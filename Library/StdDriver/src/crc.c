 ...
 * $Revision: 3 $
 * $Date: 20/05/28 2:11p $
 * @brief    M091 series Cyclic Redundancy Check(CRC) driver source file
 *
...
/**
  ...
  * @note       M091 supports programmable polynomial function \n
...
void CRC_Open(uint32_t u32Mode, uint32_t u32Attribute, uint32_t u32Seed, uint32_t u32DataLen)
{
    ...
    if(((SYS->PDID & 0xF000) >> 12) == 0x00)     /*!< Chip series is M091 */
    {
        switch(u32Mode)
        {
        case CRC_CCITT:
