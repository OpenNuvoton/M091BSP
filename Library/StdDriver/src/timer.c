 ...
 * $Revision: 3 $
 * $Date: 20/06/09 9:43a $
 * @brief    M091 Series Timer Controller (TIMER) Driver Source File
 *
 * @note
...
/**
  ...
  *
  * @param[in]  timer           The pointer of the specified Timer module.
  * @param[in]  u32DropCount    This parameter has no effect in M091 series BSP.
  * @param[in]  u32Timeout      This parameter has no effect in M091 series BSP.
